...
## and "n" is the scaffold number. In this case in its original usage this script dealt with scaffolds that
## were complete chromosomes; these were numbered from largest to smallest as "Chr_1..n".
